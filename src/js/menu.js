...
const menuItems = [
  {
    ...
    price: "$35.00",
    description:
      "Tender rib-eye grilled to perfection, served with garlic butter and rosemary.",
  },
  {
    name: "Caesar Salad",
    img: saladImg,
    price: "$20.00",
    description:
      "Crisp romaine, house-made Caesar dressing, shaved parmesan, and croutons.",
  },
  {
    ...
    price: "$25.00",
    description:
      "Hand-breaded chicken strips served with honey mustard, BBQ, or ranch.",
  },
  {
    ...
    price: "$30.00",
    description:
      "Tangy tomato sauce, melted mozzarella, smoked ham, and sweet pineapple.",
  },
];
